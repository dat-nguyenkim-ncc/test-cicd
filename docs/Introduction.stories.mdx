...
# Welcome to Expand FCT Storybook
...
We use [**Theme.ui**](https://theme-ui.com/getting-started) as the base of this application, building UIs with a [**component-driven**](https://componentdriven.org) process starting with atomic components and ending with pages.
...
<div class="tip-wrapper">
  <span class="tip">Tip</span>Edit the Markdown in <code>docs/Introduction.stories.mdx</code>
</div>
