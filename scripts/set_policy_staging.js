  ...
  Statement: [
    {
      ...
      Effect: 'Allow',
      Principal: {
        AWS: 'arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity E2T0LOQTGQ9ACM',
      },
      Action: ['s3:GetObject'],
      Resource: [''],
    },{
      ...
      Action: "s3:PutObject",
      Resource: [
        "arn:aws:s3:::ftct-dashboard-fe-staging",
        "arn:aws:s3:::ftct-dashboard-fe-staging/*"
      ],
      Condition: {
        StringNotLike: {
          "aws:PrincipalArn": "arn:aws:iam::510656726199:user/FE-CI"
        }
      }
    }
  ],
